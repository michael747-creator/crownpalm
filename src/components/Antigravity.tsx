...
const AntigravityInner = ({
    ...
    const virtualMouse = useRef<Vec2>({ x: 0, y: 0 });
...
/**
 * SSR-safe wrapper:
 * - R3F/three relies on browser APIs.
 * - We only render the Canvas after mount to avoid hydration mismatches.
 */
