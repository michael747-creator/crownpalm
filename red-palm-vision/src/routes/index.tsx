...
import { Phone, Clock, Star, MapPin, Leaf, Award, ShieldCheck, ArrowRight, MessageCircle, Truck } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          {products.map((p) => (
            <div
              key={p.name}
              className={`group relative overflow-hidden rounded-2xl border border-border bg-card p-8 transition hover:border-accent/50 hover:shadow-glow md:col-span-2 md:row-span-1 md:p-10 product-option ${selectedProduct === p.name ? "selected" : ""
                }`}
